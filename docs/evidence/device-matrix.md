...
temporary network loss, resume, and final result. A desktop facilitator must verify roster and
report reconciliation.

| Device/OS           | Browser/version | Network                    | QR      | Play    | Reconnect | Report  | Issue |
| ------------------- | --------------- | -------------------------- | ------- | ------- | --------- | ------- | ----- |
...
| Windows laptop      | Chrome/Edge     | Managed Wi-Fi              | Pending | Pending | Pending   | Pending |       |
...
- Thirty-device concurrent lobby result:
- Camera/QR permission observations:
- Firewall, captive portal, or WebSocket restrictions:
